...
<div v-else class=" px-10 my-4 py-6 bg-white rounded-lg shadow-md">
        <div class="flex justify-between items-center">
            ...
            <p v-if="isOpen" class="px-2 py-1 bg-green-500 text-gray-100 font-bold rounded">Open</p>
...
export default {
    ...
    setup(){
        ...
        const fetchResults = async () => {
            ...
            const res = await axios.get(`http://192.168.1.9:8000/place_detail?place_id=${place_id}`);
        ...
        const fetchReview = async () => {
            ...
            const res = await axios.get(`http://192.168.1.9:8000/restaurant_review?place_id=${place_id}`);
        ...
        const isOpen =  computed(function () {
            if(state.data.opening_hours.open_now === true){
                return true
            }
            else {
                return false
